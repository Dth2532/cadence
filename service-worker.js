...
const urlsToCache = [
  ...
  'https://fonts.googleapis.com/css2?family=Caveat:wght@600;700&family=Crimson+Text:ital,wght@0,400;0,600;1,400&display=swap',
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('Cadence', options)
  );
});
